	...
	render() {
		return (
				<section css={splash}>
					...
					>
						<img css={{boxShadow: '-2px 2px 0px rgba(0, 0, 0, 0.09)'}}src={splashImg} alt=""/>
					</figure>
					<section
						css={{
							display: 'flex',
					...
					>
						<a css={{width: '100%', cursor: 'pointer'}} href="mailto:marisa@marisariveraart.com">
						...
						>
							<img css={{...socialLinkIcon, padding: '12px 0'}} src={instaIcon} alt=""/>
						</a>
